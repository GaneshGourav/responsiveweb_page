export const Home = () =>{
    ...
    <div className="flex px-36 py-24 items-center gap-28 self-stretch border border-red-400 font-[Inter] text-left">
        ...
        <div>
            <p className="border border-red-400 font-[Inter] font-medium text-6xl text-[#4D4D4D] self-stretch  ">Lessons and insights <br /><span className="text-[#4CAF4F]">from 8 years</span> </p> 
